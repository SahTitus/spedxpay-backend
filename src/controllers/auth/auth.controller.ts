...
export class AuthController {
  ...
  verifyEmail = asyncHandler(
    async (req: AuthRequest, res: Response, next: NextFunction) => {
      ...
      res
        .status(200)
        .json(successResponse("Email verified successfully", result));
    }
  );
  ...
  requestPasswordReset = asyncHandler(
    async (req: AuthRequest, res: Response, next: NextFunction) => {
      ...
      res
        .status(200)
        .json(successResponse("Password reset email sent", result));
    }
  );
  ...
  resetPassword = asyncHandler(
    async (req: AuthRequest, res: Response, next: NextFunction) => {
      ...
      res
        .status(200)
        .json(successResponse("Password reset successfully", result));
    }
  );
