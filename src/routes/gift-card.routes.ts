...
import { GiftCardController } from "../controllers/gift-card/gift-card.controller.js";
...
} from "../validators/gift-card.validator.js";
...
router.post(
  "/sell",
  validation.validate({ body: sellGiftCardSchema }),
...
router.post(
  "/buy",
  validation.validate({ body: buyGiftCardSchema }),
