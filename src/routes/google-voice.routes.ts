...
// Create order
router.post("/orders", validation.validate({ body: createGoogleVoiceOrderSchema }), googleVoiceController.createOrder)
...
// Get specific order
router.get("/orders/:orderId", validation.validate({ params: orderIdParamSchema }), googleVoiceController.getOrder)
