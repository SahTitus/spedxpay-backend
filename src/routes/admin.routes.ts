...
router.post(
  "/kyc/:kycId/review",
  validation.validate({ body: reviewKycSchema }),
...
router.get(
  "/gift-cards/sell-orders/pending",
  adminController.getPendingSellOrders
);
router.get(
  "/gift-cards/buy-orders/pending",
  adminController.getPendingBuyOrders
);
...
router.post(
  "/gift-cards/:giftCardId/complete-sale",
  adminController.completeGiftCardSale
);
router.post(
...
router.get(
  ...
  adminController.getPendingGoogleVoiceOrders
);
...
router.put(
  "/config",
  validation.validate({ body: updatePlatformConfigSchema }),
...
router.post(
  "/roles/invite",
  validation.validate({ body: inviteAdminSchema }),
  adminRoleController.inviteAdmin
);
router.get("/roles/invitations", adminRoleController.getPendingInvitations);
router.post(
  "/roles/invitations/:invitationId/cancel",
  adminRoleController.cancelInvitation
);
router.post(
  "/roles/invitations/:invitationId/resend",
  adminRoleController.resendInvitation
);
