...
// Create transactions
router.post("/sell", validation.validate({ body: sellCryptoSchema }), cryptoTradingController.sellCrypto)

router.post("/buy", validation.validate({ body: buyCryptoSchema }), cryptoTradingController.buyCrypto)
...
router.get("/platform/payment-details", cryptoTradingController.getPlatformPaymentDetails)
