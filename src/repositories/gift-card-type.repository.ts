...
export class GiftCardTypeRepository {
  ...
  async update(id: string, data: Partial<IGiftCardType>): Promise<IGiftCardType | null> {
    return GiftCardType.findByIdAndUpdate(id, { $set: data }, { new: true, runValidators: true })
  }
