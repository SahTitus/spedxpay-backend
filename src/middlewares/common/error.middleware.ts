...
export function errorMiddleware(error: CustomError, req: Request, res: Response, next: NextFunction): void {
  ...
  let message = error.message || ERROR_MESSAGES[ERROR_CODES.INTERNAL_SERVER_ERROR]
...
export function createError(message: string, statusCode: number, code: string, details?: any): CustomError {
